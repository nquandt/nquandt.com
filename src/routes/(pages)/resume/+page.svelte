...
<div
	transition:fade
	class="absolute flex flex-col w-full items-center md:p-12 p-3 md:pb-12 pb-32 overflow-y-scroll h-[calc(100vh-100px)]"
>
					...
					<div class="relative flex-shrink-0 overflow-hidden border-b-2 border-gray-300">
						<div class="top-0 left-0 w-full h-full flex justify-center items-center absolute">
							<picture class="w-full h-full">
								...
								<source media="(min-width: 1921px)" srcset="/resume-3840w.webp" />
								<img
									class="object-cover w-full h-full opacity-60"
									src="/resume-3840w.webp"
									alt="header background"
								/>
							</picture>
						</div>
						<div class="relative flex w-full justify-center md:px-8 py-8">
							<div
					...
					<div class="px-6 gap-6 py-6 flex md:flex-nowrap flex-wrap">
						<div class="md:w-1/3 flex flex-col gap-6 print:gap-4">
							<Section title="Summary">
								<div class="print:text-sm">
									Full-Stack Developer, with an affinity for object-oriented development and
						...
						<div class="md:w-2/3 flex flex-col gap-6">
							...
							<Section title="Projects" icon={GithubSvg} leftAlignTitle={true}>
								...
								>
									<ul>
										<li>All of the code for my website is available on github.</li>
										<li>I'm utilizing svelte as an FE framework, and vite for building as SSG.</li>
									</ul>
								</TalkingPoint>
								<TalkingPoint
								...
								>
									<ul>
										<li>
											...
											where one route equates to one file (endpoint).
										</li>
										<li>
											It intends to abstract the registration process of <span class="font-mono"
												>app.MapMethod(...)</span
											> by utilizing a standard pattern for an "Endpoint".
										</li>
										<li>
											This utilizes a new C# feature, static abstract generics to create a fluent
											api for creating endpoints for various needs.
										</li>
										<li>
											The endpoints provide full dependency resolution via typical constructor
											injection.
										</li>
										<li>
											Serialization is abstracted by allowing a user to inject an <span
												class="font-mono">IJsonSerializer</span
								...
								>
									<ul>
										...
										<li>
											...
											interaction and headless methods.
										</li>
										<li>
											Utilizes chromium's ability to bidirectionally invoke commands in the parent
											C# application from page-level javascript. Script injection is used to link
											commands between the webpage and application.
										</li>
										<li>Primary UI utilizes XAML WinForms.</li>
										<li>
								...
								>
									<ul>
										<li>
											Parallel implementations of mathematical functions taken over a set of values.
										</li>
										<li>Optimized for <span class="font-mono">WORD</span> sized values.</li>
										<li>
											Example <span class="font-mono">>_: setgcd 42 91 77 140</span><span
												class="pl-8">output: <span class="font-mono">7</span></span
											>
										</li>
									</ul>
								</TalkingPoint>
