...
<flexc transition:fade class="absolute p-16 bgPrimary min-h-full justify-start">
	...
	<div class="flex justify-center p-8 gap-4">
		<div class="flex w-1/2">
			...
			"GenericCatalogApi". This api exists in my project as an Azure Function, with a connection to
			a Storage Account table. Similarily you could host any api on a server or serverless and point
			at that instead. I've explicitly used svelte's `onMount` function to ensure this code will
			only be executed client-side. During compilation for SSR/SSG the svelte compiler actually
